...
$.get(currentURL + "/api", function(data){
	...
	for (var i =0; i < data.length; i++){
		...
		// the role an h3,
		$("#characterWell-" + i).append("<h3>Role: " + data[i].address + "</h4>");
		$("#characterWell-" + i).append("<h3>Long: " + data[i].long + " Lat: " + data[i].lat + "</h4>");
		// the points an h3,
		$("#characterWell-" + i).append("<h3>Points: " + data[i].points + "</h4>");	
	}
})
